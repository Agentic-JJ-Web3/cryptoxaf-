  ...
  return (
    <div className="max-w-[560px]">
      ...
      <div className="flex items-center justify-between border-b border-rule pb-4">
        <div>
          <div className="mb-1.5 font-mono text-[11px] uppercase tracking-wider text-muted">Order detail</div>
      ...
      <div className="border-b border-rule-soft py-4.5">
        ...
        {order.rateSnapshot && (
          <>
            ...
            <LedgerRow label="Network fee" value={`${formatXaf(order.rateSnapshot.networkFeeXaf)} XAF`} tone="fee" />
          </>
        )}
      ...
      <div className="border-b border-rule-soft py-4.5">
        <div className="mb-2.5 flex items-center justify-between">
          <div className="font-mono text-[10px] uppercase tracking-wider text-muted">Destination wallet</div>
