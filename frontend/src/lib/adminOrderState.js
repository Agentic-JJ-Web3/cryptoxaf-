...
const STATE_META = {
  ...
  AWAITING_DEPOSIT: { label: 'Awaiting deposit', color: 'var(--muted)', weight: 400, actionable: false },
  DEPOSIT_CLAIMED: { label: 'Verify deposit', color: 'var(--ink)', weight: 600, actionable: true },
  DEPOSIT_VERIFIED: { label: 'Send MoMo', color: 'var(--ink)', weight: 600, actionable: true },
